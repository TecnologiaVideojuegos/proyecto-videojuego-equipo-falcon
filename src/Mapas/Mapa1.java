...
public class Mapa1 extends MapaT {
    ...
    private PersonajeUpDown marinero1 = new PersonajeUpDown(1160, 480, "M1", "Marinero");
    private PersonajeEstaticoA marinero2 = new PersonajeEstaticoA("left", 920, 150, "T0", "Tendero3");
    private PersonajeEstaticoA marinero3 = new PersonajeEstaticoA("right", 880, 150, "T3", "Tendero4");
    private PersonajeEstatico marinero4 = new PersonajeEstatico("up", 1050, 130, "M3", "Marinero");
    private PersonajeCirculoR anciano1 = new PersonajeCirculoR(580, 350, "V0", "Anciano2");
    private PersonajeCirculoL anciano2 = new PersonajeCirculoL(200, 300, "V1", "Anciano1");
