...
public class Mapa8 extends MapaT{
    ...
    private float   puntos3 []  = new float[]{1116,321,1033,321,1033,307,981,307,981,321,898,321,898,161,1116,161};
    private float   puntos4 []  = new float[]{606,257,523,257,523,243,471,243,471,257,350,257,350,232,388,232,388,97,606,97};
    ...
    private float   puntos22[] = new float[]{258,3,1500,3,1500,2,258,2};
    ...
    //casa - carretera arriba - plaza central
    private float   mapas[] = new float[]{1,8,0};
    private float   coord[] = new float[]{825,640,0,720,0,0};
