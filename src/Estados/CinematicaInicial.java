...
public class CinematicaInicial extends BasicGameState {
    ...
    Historia bocadilloB1 = new Historia("inip0");
    Historia bocadilloB2 = new Historia("inip1");
    Historia bocadilloB3 = new Historia("inip2");
    Historia bocadilloB4 = new Historia("inip3");
    Historia bocadilloB5 = new Historia("inip4");
    Historia bocadilloB6 = new Historia("inip5");
