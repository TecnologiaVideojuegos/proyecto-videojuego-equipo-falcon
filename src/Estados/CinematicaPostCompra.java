 ...
 * @author lucas
 */
public class CinematicaPostCompra extends BasicGameState {
    ...
    private Historia bocadilloB1 = new Historia("ini40");
    private Historia bocadilloB2 = new Historia("ini41");
    private Historia bocadilloB3 = new Historia("ini42");
